...
(custom-theme-set-faces
 ...
 '(font-lock-comment-face ((((class color) (min-colors 89)) (:foreground "#586e75" :slant normal))))
 ...
 '(font-lock-doc-string-face ((((class color) (min-colors 89)) (:foreground "#6c71c4"))))
 ...
 '(flycheck-fringe-error ((((class color) (min-colors 89)) (:foreground "#dc322f" :inverse-video t))))
 '(flycheck-fringe-info ((((class color) (min-colors 89)) (:foreground "#2aa198" :inverse-video t))))
 '(flycheck-fringe-warning ((((class color) (min-colors 89)) (:foreground "#b58900" :inverse-video t))))
 '(flymake-warnline ((((class color) (min-colors 89)) (:underline (:style wave :color "#b58900") :background "#002b36"))))
 '(flymake-errline ((((class color) (min-colors 89)) (:underline (:style wave :color "#dc322f") :background "#002b36"))))
 ...
 '(diff-hl-insert ((((class color) (min-colors 89)) (:background "#859900"))))
 '(diff-hl-change ((((class color) (min-colors 89)) (:background "#268bd2"))))
 '(diff-hl-delete ((((class color) (min-colors 89)) (:background "#b58900"))))
 '(diff-hl-unknown ((((class color) (min-colors 89)) :background "#6c71c4")))
 ...
 '(magit-log-head-label-head ((((class color) (min-colors 89)) (:foreground "#cb4b16" :box nil :weight bold))))
 ...
 '(magit-log-head-label-wip ((((class color) (min-colors 89)) (:foreground "#268bd2" :box nil :weight bold))))
 ...
 '(helm-buffer-size ((((class color) (min-colors 89)) (:foreground "#6c71c4"))))
 '(helm-buffer-not-saved ((((class color) (min-colors 89)) (:foreground "#b58900"))))
 '(helm-buffer-process ((((class color) (min-colors 89)) (:foreground "#2aa198"))))
 '(helm-buffer-directory ((((class color) (min-colors 89)) (:foreground "#268bd2"))))
 '(helm-ff-directory ((((class color) (min-colors 89)) (:foreground "#2aa198"))))
 '(helm-candidate-number ((((class color) (min-colors 89)) (:foreground "#dc322f"))))
 '(helm-selection ((((class color) (min-colors 89)) (:inherit highlight))))
 '(helm-separator ((((class color) (min-colors 89)) (:foreground "#d33682"))))
 '(helm-source-header ((((class color) (min-colors 89)) (:weight bold :foreground "#b58900" :height 1.44))))
 ...
 '(highlight-symbol-face ((((class color) (min-colors 89)) (:background "#073642" :weight bold))))
 ...
 '(powerline-active1 ((((class color) (min-colors 89)) (:foreground "#839496" :background "#eee8d5"))))
 '(powerline-active2 ((((class color) (min-colors 89)) (:foreground "#839496" :background "#073642"))))
 ...
 '(ledger-font-payee-cleared-face ((((class color) (min-colors 89)) (:foreground "#859900"))))
 '(ledger-font-payee-uncleared-face ((((class color) (min-colors 89)) (:foreground "#2aa198"))))
 '(ledger-font-posting-date-face ((((class color) (min-colors 89)) (:foreground "#b58900"))))
 '(ledger-font-posting-amount-face ((((class color) (min-colors 89)) (:foreground "#839496"))))
 '(ledger-font-posting-account-cleared-face ((((class color) (min-colors 89)) (:foreground "#268bd2"))))
 '(ledger-font-posting-account-face ((((class color) (min-colors 89)) (:foreground "#6c71c4"))))
 '(ledger-font-posting-account-pending-face ((((class color) (min-colors 89)) (:foreground "#b58900"))))
 ...
 '(twittering-uri-face ((((class color) (min-colors 89)) (:foreground "#268bd2" :inherit link))))
 '(twittering-timeline-header-face ((((class color) (min-colors 89)) (:foreground "#859900" :weight bold))))
